...
A comprehensive, full-stack web application designed to streamline and automate lumberyard operations, including inventory management, production tracking, timber treatment processes, labor management, and financial operations.
...
The **Lumberyard Management System** is an enterprise-grade application built to manage all aspects of a modern lumberyard operation. It provides real-time tracking of inventory (timber, logs, and chemicals), manages production workflows from raw material to finished products, oversees timber treatment processes, handles worker attendance and payroll, and maintains comprehensive financial records.

### Who Built This System

This system was developed as a comprehensive solution for lumberyard operations management, integrating multiple business processes into a single, unified platform. The application features role-based access control, ensuring that each user only sees and interacts with the functionality relevant to their responsibilities.

### Target Users

- **Lumberyard Administrators** - Complete system oversight
- **Inventory Operations Managers** - Stock and material management
- **Labor Managers** - Workforce and attendance management
- **Finance Managers** - Financial tracking and reporting
...
# Configure database (optional - defaults to local MySQL)
...
1. **Database Initialization:** The application automatically creates the database schema on first run
2. **Admin Account:** Create an initial admin user by directly inserting into the database or using the registration endpoint
3. **Login:** Access the application at `http://localhost:3000` and log in with your credentials
...
- **Full Deployment Guide:** [full_deployment_guide.md](../full_deployment_guide.md)
...
3. Configure environment variables (database URL, JWT secret, etc.)
4. Deploy - Render automatically builds using Maven

#### Frontend (Netlify)
1. Connect your GitHub repository to Netlify
2. Set build command: `cd LumberyardManagement/lumberyard-frontend && npm run build`
3. Set publish directory: `LumberyardManagement/lumberyard-frontend/build`
4. Configure `_redirects` file for SPA routing
5. Deploy

#### Database (TiDB Cloud)
1. Create a TiDB Cloud cluster (MySQL-compatible)
2. Configure connection string in backend environment variables
3. Run initial schema migration (automatic with `ddl-auto=update`)
...
### Important Notes
- Never commit `.env` files or `application.properties` with real credentials
...
4. **Test thoroughly** - Ensure backend and frontend work correctly
5. **Commit your changes:** `git commit -m 'Add some feature'`
6. **Push to the branch:** `git push origin feature/your-feature-name`
7. **Submit a Pull Request**

### Code Standards
- **Backend:** Follow Java/Spring Boot conventions, use Lombok annotations
...
This project is proprietary software developed for lumberyard operations management. All rights reserved.
...
- **System Documentation:** See [full_deployment_guide.md](../full_deployment_guide.md) for deployment details
- **QA Testing:** Refer to [Financial_QA_Testing_Document.md](../Financial_QA_Testing_Document.md) for testing guidelines
- **Issues:** Report bugs or request features through your organization's issue tracking system
...
- [ ] Enhanced reporting with export to Excel/CSV
